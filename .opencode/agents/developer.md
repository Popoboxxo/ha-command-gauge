...
permission:
  ...
  todowrite: allow
---
> **Extension:** If `.opencode/3-project/hcg-developer-ext.md` exists → read and apply immediately.
...
4. **Read context:** `.opencode/3-project/hcg-developer-ext.md` if present.
