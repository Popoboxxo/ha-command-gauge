...
permission:
  ...
  edit: allow
---
> **Extension:** If `.opencode/3-project/hcg-openscad-developer-ext.md` exists → read and apply immediately.
...
**OpenSCAD snippets:** `.opencode/snippets/openscad-patterns/` (sync-generated) — `gear.scad`, `thread.scad`, `chamfer.scad`, etc.
</context>
