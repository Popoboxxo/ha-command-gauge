...
permission:
  ...
  todowrite: allow
---
> **Extension:** If `.opencode/3-project/hcg-sre-engineer-ext.md` exists → read and apply immediately.
...
2. **Read context:** `.opencode/3-project/hcg-sre-engineer-ext.md` if present.
