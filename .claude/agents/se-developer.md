...
hint: 'Standard SE leaf node implementation. Handles multiple interfaces (2-4). Escalates
  cross-cutting or boundary-level leafs.
...
> **Extension:** If `.claude/3-project/hcg-se-developer-ext.md` exists → read and apply it immediately.
