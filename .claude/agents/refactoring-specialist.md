...
> **Extension:** If `.claude/3-project/hcg-refactoring-specialist-ext.md` exists → read and apply immediately.
...
2. **REQ check:** 
3. **Read context:** `.claude/3-project/hcg-refactoring-specialist-ext.md` if present.
