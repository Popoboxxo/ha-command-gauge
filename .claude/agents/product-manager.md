...
hint: 'Produkt-Management: Backlog, User-Stories, Sprint-Planung, Priorisierung (RICE/MoSCoW),
  KPIs, Stakeholder — strategisch/geschäftsorientiert'
prompt_mode: modern
tools:
- Read
- Write
...
> **Extension:** If `.claude/3-project/hcg-product-manager-ext.md` exists → read and apply immediately.
...
2. **Read context:** `.claude/3-project/hcg-product-manager-ext.md` if present.
