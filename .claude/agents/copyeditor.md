...
> **Extension:** If `.claude/3-project/hcg-copyeditor-ext.md` exists → read and apply immediately.
...
2. **Read context:** `.claude/3-project/hcg-copyeditor-ext.md` if present — project-specific tone/voice guide, glossary of preferred terms, target audience.
