...
> **Extension:** If `.claude/3-project/hcg-feedback-ext.md` exists → read and apply immediately.
...
Full templates: `.claude/snippets/feedback-templates.md` (sync-generated). Before submit run a **pre-submit completeness check**: all required fields present and non-empty? Missing context → fill it, do not create a raw/incomplete issue.
