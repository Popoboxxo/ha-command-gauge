...
hint: 'Backend review: API contracts, silent failures, concurrency, middleware — evidence-based
...
> **Extension:** If `.claude/3-project/hcg-backend-reviewer-ext.md` exists → read and apply immediately.
